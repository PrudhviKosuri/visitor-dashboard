...
import { User, Mail, Phone, MapPin, Building, Calendar, Edit2, Save, X, LogOut, Users } from 'lucide-react';
      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        >
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-2">
              Manage your startup and personal information
            </p>
          </div>
          <motion.button
        ...
        <div className="max-w-5xl">
            ...
            <div className="px-8 pb-8">
              <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6 -mt-16 mb-8">
                ...
                <div className="text-center sm:text-left mb-4 flex-1">
                  ...
                  <p className="text-lg text-blue-600 font-semibold">{profileData.startupName}</p>
                  <p className="text-slate-600 dark:text-slate-400">{profileData.role}</p>
                  <div className="flex items-center gap-4 mt-2 text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <div className="flex items-center gap-1">
                      <Users size={16} />
                      <span>{profileData.teamSize} team members</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <motion.div
            ...
            className="mt-6 bg-gradient-to-r from-blue-600 to-sky-500 rounded-2xl shadow-xl p-6 text-white"
          >
            <h3 className="text-lg font-bold mb-4">Management Summary</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl text-center">
                <p className="text-3xl font-bold">127</p>
                <p className="text-sm text-blue-100 mt-1">Total Visitors</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl text-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl text-center">
                ...
                <p className="text-sm text-blue-100 mt-1">Pending</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm p-4 rounded-xl text-center">
                <p className="text-3xl font-bold">94%</p>
                <p className="text-sm text-blue-100 mt-1">Approval Rate</p>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            >
              ...
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-sky-500 text-white font-semibold py-3 rounded-xl hover:from-blue-700 hover:to-sky-600 transition-all duration-200"
                  onClick={(e) => {
                    e.preventDefault();
                    setShowModal(false);
                  }}
